...
public class FocusManager {
    ...
    // public FocusManager(ComboPreferences preferences, String[]
    // defaultFocusModes) {
    ...
    public void initializeParameters(Parameters parameters) {
        ...
        mLockAeAwbNeeded = (mParameters.isAutoExposureLockSupported() || mParameters
                .isAutoWhiteBalanceLockSupported());
    }

    public void initialize(View focusIndicatorRotate, View previewFrame,
    /* FaceView faceView, */Listener listener, boolean mirror,
            int displayOrientation) {
        mFocusIndicatorRotateLayout = focusIndicatorRotate;
        mFocusIndicator = (FocusIndicatorView) focusIndicatorRotate
        ...
        if (mState == STATE_FOCUSING_SNAP_ON_FINISH) {
            ...
            if (focused) {
                ...
                if (!Parameters.FOCUS_MODE_CONTINUOUS_PICTURE
                        .equals(mFocusMode) || mSoundPlayer != null) {
                    mSoundPlayer.play();
                }
            } else {
                mState = STATE_FAIL;
    ...
    public boolean onTouch(Context context, MotionEvent e) {
        ...
        calculateTapArea(focusWidth, focusHeight, 1.5f, x, y, previewWidth,
                previewHeight, mMeteringArea.get(0).rect);
        ...
        int top = Util.clamp(y - focusHeight / 2, 0, previewHeight
                - focusHeight);
        p.setMargins(
                left,
                top
                        - (int) context.getResources().getDimension(
                                R.dimen.action_bar_height), 0, 0);
        // Disable "center" rule because we no longer want to put it in the
        // center.
        int[] rules = p.getRules();
        rules[RelativeLayout.CENTER_IN_PARENT] = 0;
        mFocusIndicatorRotateLayout.requestLayout();
        // Stop face detection because we want to specify focus and metering
        // area.
    ...
    public void initializeSoundPlayer(Context context, AssetFileDescriptor fd) {
        mSoundPlayer = new SoundPlayer(context, fd);
    }
    ...
    public String getFocusMode() {
        ...
        if (mFocusAreaSupported && mFocusArea != null) {
            ...
            mFocusMode = null;
            // mPreferences.getString(CameraSettings.KEY_FOCUS_MODE, null);
    ...
    public void calculateTapArea(int focusWidth, int focusHeight,
